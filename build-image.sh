...
pushd "cri-o" && {
  ...
  sealos build --debug -t dev-crio:1.23.5 .
}
popd
...
sealos merge -t dev-merge-crio-k8s:1.23.17 dev-k8s:1.23.17 dev-crio:1.23.5 dev-crun:1.8.1 dev-tools dev-sealos:4.1.6 dev-registry:2.8.1 dev-tools
